# Logos des OPCO / financeurs

Déposer ici les logos **officiels** (PNG à fond transparent de préférence, ou SVG) :
...
automatiquement sur le site (accueil + page Financement) et le nom sert de
repli tant que le fichier est absent.
