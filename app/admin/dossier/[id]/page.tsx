...
import styles from "../../programme/[id]/programme.module.css";
      ...
      <div className="container container-narrow">
        ...
        <article className={doc.sheet}>
          <div className={doc.head}>
            ...
            <h1 className={doc.docTitle}>Dossier de financement — OPCO</h1>
          </div>
          ...
          <h2 className={doc.h2}>Modalités d&rsquo;accompagnement</h2>
          {formation.modalitesAccompagnement && (
            <p className={styles.prose}>{formation.modalitesAccompagnement}</p>
          )}
          <ul className={styles.objList}>
            <li>
              Tutorat asynchrone : l&rsquo;apprenant pose ses questions depuis
              chaque module, réponses du formateur horodatées et tracées.
            </li>
            <li>
              Sessions live collectives (visioconférence) avec feuille de
              présence.
            </li>
            <li>
              Suivi d&rsquo;assiduité mesuré en continu (temps de visionnage réel
              par module) — rapport et attestation d&rsquo;heures disponibles.
            </li>
          </ul>

          <div className={doc.foot}>
            <p>
              {site.name} — Organisme de formation certifié Qualiopi. Formation à
              distance conforme aux conditions de prise en charge OPCO (programme
              détaillé, preuve d&rsquo;assiduité vérifiable, accompagnement
              humain traçable).
            </p>
          </div>
        </article>
